<?php namespace Atiker\LaravelBootstrap\Utilities;
use Atiker\LaravelBootstrap\Uploads\Uploads;
...
class ImgHelper {
    ...
    private function resize(){
        ...
        if( $this->crop )
            ...
            $img->resize( $this->width , $this->height )->resizeCanvas( $this->width , $this->height , null , false , 'ffffff' )->save( $this->getPathFilename() );
