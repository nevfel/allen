<?php namespace Atiker\LaravelBootstrap\Core;
use Atiker\LaravelBootstrap\Core\Exceptions\NoValidationRulesFoundException;
...
class EloquentBaseModel extends Eloquent
{
    ...
    */
    ...
    {
        return in_array( 'Atiker\LaravelBootstrap\Abstracts\Traits\TaggableRelationship' , ( new ReflectionClass( $this ) )->getTraitNames() );
    }
    ...
    {
        return in_array( 'Atiker\LaravelBootstrap\Abstracts\Traits\UploadableRelationship' , ( new ReflectionClass( $this ) )->getTraitNames() );
    }
    ...
    {
        return in_array( 'Atiker\LaravelBootstrap\Abstracts\Traits\MenuableRelationship' , ( new ReflectionClass( $this ) )->getTraitNames() );
    }            
