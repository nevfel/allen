...
<html lang="en">
    <head>
        ...
        @section('css')
            ...
            <link rel="stylesheet" href="{{ asset('admin/css/jquery.tagsinput.min.css') }}">
            <link rel="stylesheet" href="{{ asset('admin/css/redactor.css') }}">
        @show
    ...
    <body class="interface">
        ...
        @section('scripts')
            ...
            <script src="{{ asset('admin/js/redactor.min.js') }}"></script>
            <script>
